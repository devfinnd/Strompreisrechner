        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    price_per_month = table.Column<decimal>(type: "TEXT", nullable: false),
                    price_per_day = table.Column<decimal>(type: "TEXT", nullable: false),
                    price_per_hour = table.Column<decimal>(type: "TEXT", nullable: false),
                    price_per_minute = table.Column<decimal>(type: "TEXT", nullable: false),
